...
import { Box, FormControl, FormControlLabel, FormHelperText, Grid, InputLabel, MenuItem, Select, TextField } from '@mui/material';
import DatePicker from '../../../components/main/DatePicker'
import { useDispatch, useSelector } from 'react-redux';
import SwJobCat from '../../../components/sw/SwJobCat';
import { createDemand, getOldDataDemand, resetOldData, updateDemand } from '../../../slices/backOffice/documentSlice';
...
const CreateDemand = ({isOpen,setIsOpen})=>{
  ...
  const oldDataDemand = useSelector(state=> state.Document.oldDataDemand)
  ...
  React.useEffect(()=>{
    if(oldDataDemand){
        ...
        setValue('training_period_wage_scale', oldDataDemand.training_period_wage_scale)
        ...
        setCatJp(oldDataDemand.job_category_jp)
        setCatEng(oldDataDemand.job_category_eng)
        setCatMm(oldDataDemand.job_category_mm  )
    }
  },[oldDataDemand])
  ...
  React.useEffect(()=>{
    ...
    if(currentGroup && currentGroup?.data?.demand_letter_date){
        dispatch(getOldDataDemand(currentGroup?.data))
    }else{
        dispatch(resetOldData())
        reset()
        setPayMeth("")
        setOathDate(null)
        setDemandDate(null)
                    ...
                    <Grid container spacing={2} columns={12}>
                        {
                            type === '2' ?
                            <Grid item xs={3}>
                                <SwJobCat mm={catMm} setMm={setCatMm} eng={catEng} setEng={setCatEng} jp={catJp} setJp={setCatJp}></SwJobCat>
                            </Grid>
                            :
                            <>
                                <Grid item xs={3}>
                                    <TextField label="Job Category(English)" {...register('job_category_eng')} error={!!errors?.job_category_eng} helperText={errors?.job_category_eng?.message} fullWidth placeholder='Job Category (English)'></TextField>
                                </Grid>
                                <Grid item xs={3}>
                                    <TextField label="Job Category(Burmese)" {...register('job_category_mm')} error={!!errors?.job_category_mm} helperText={errors?.job_category_mm?.message} fullWidth placeholder='Job Category (Burmese)'></TextField>
                                </Grid>
                                <Grid item xs={3}>
                                    <TextField label="Job Category(Japanese)" {...register('job_category_jp')} error={!!errors?.job_category_jp} helperText={errors?.job_category_jp?.message} fullWidth placeholder='Job Category (Japanese)'></TextField>
                                </Grid>
                            </>
                        ...
                        <Grid item xs={3}>
                            <TextField label="Work Place(Japan)" {...register('work_place')} error={!!errors?.work_place} helperText={errors?.work_place?.message} fullWidth placeholder='Workplace'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Working Day (English)" {...register('working_day_eng')} error={!!errors?.working_day_eng} helperText={errors?.working_day_eng?.message} fullWidth placeholder='Working Day (English)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Working Day (Burmese)" {...register('working_day_mm')} error={!!errors?.working_day_mm } helperText={errors?.working_day_mm?.message} fullWidth placeholder='Working Day (Myanmar)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Holiday(English)" {...register('holiday_eng')} error={!!errors?.holiday_eng} helperText={errors?.holiday_eng?.message} fullWidth placeholder='Holiday (English)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Holiday(Burmese)" {...register('holiday_mm')} error={!!errors?.holiday_mm} helperText={errors?.holiday_mm?.message} fullWidth placeholder='Holiday (Myanmar)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Working Hours(English)" {...register('working_hours_eng')} error={!!errors?.working_hours_eng} helperText={errors?.working_hours_eng?.message} fullWidth placeholder='Working Hours (English)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Working Hours(Burmese)" {...register('working_hours_mm')} error={!!errors?.working_hours_mm} helperText={errors?.working_hours_mm?.message} fullWidth placeholder='Working Hours (Myanmar)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Qualification(English)" {...register('qualification_eng')} error={!!errors?.qualification_eng} helperText={errors?.qualification_eng?.message} fullWidth placeholder='Qualification (English)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Qualification(Burmese)" {...register('qualification_mm')} error={!!errors?.qualification_mm} helperText={errors?.qualification_mm?.message} fullWidth placeholder='Qualification (Myanmar)'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Training Period Wage Scale" {...register('training_period_wage_scale')} error={!!errors?.training_period_wage_scale} helperText={errors?.training_period_wage_scale?.message} fullWidth placeholder='Training Period Wage Scale'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                            <TextField label="Basic Salary" {...register('basic_salary')} error={!!errors?.basic_salary} helperText={errors?.basic_salary?.message} fullWidth placeholder='Basic Salary'></TextField>
                        </Grid>
                        <Grid item xs={3}>
                        ...
                        <Grid item xs={3}>
                            <TextField label="Accommodation" {...register('accommodation')} error={!!errors?.accommodation} helperText={errors?.accommodation?.message} fullWidth placeholder='Accommodation'></TextField>
                        </Grid>
                        <Grid item xs={3}>
